                ...
                <div className="col-lg-4">
                    <div className="trainer-item">
                        ...
                        <div className="down-content">
                            ...
                            <h4>Hector T. Silva</h4>
                            <p>Expert muscle trainer dedicated to sculpting bodies and maximizing strength gains. Tailoring workouts to individual needs, employing advanced techniques for muscle development. Achieve transformative results with training.</p>
                            <ul className="social-icons">
                ...
                <div className="col-lg-4">
                    <div className="trainer-item">
                        ...
                        <div className="down-content">
                            ...
                            <h4>Paul D. Naeen</h4>
                            <p>Specialized power trainer focused on maximizing strength and explosive performance. Crafting dynamic workouts tailored to goals, emphasizing powerlifting. Inspiring clients to push boundaries.</p>
                            <ul className="social-icons">
                                <li><a href="#"><i className="fa fa-facebook"></i></a></li>
                                <li><a href="#"><i className="fa fa-twitter"></i></a></li>
                                <li><a href="#"><i className="fa fa-linkedin"></i></a></li>
